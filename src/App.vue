<template>
  <v-app style="background-image: url('https://i.gyazo.com/51981baf4003f7be3c81cb3ee4eb0600.jpg'); background-size: cover; background-position: center;">
    <v-app-bar
      ...
      dark
    >
      <v-img src="https://i.gyazo.com/b6b274cdc48f945d2f06cf10484b080d.png" contain class="mt-2 ml-4 mb-3" max-width="30"></v-img>
      <v-toolbar-title class="black--text mr-4 text-h5">みちしるべ
      </v-toolbar-title>
